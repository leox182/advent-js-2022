/* 
  ...
  y están preparando un programa que les diga el número de horas extras que harían en el 
  año si se aplicara la nueva norma.

  Al ser trabajo de oficina, su horario laboral es de lunes a viernes. Así que sólo tienes que 
  preocuparte de los días festivos que caen en esos días.
...
export default function countHours(year, holidays) {
  ...
  if (typeof year !== "number" || !Array.isArray(holidays))
    throw new Error("parameters must be provided")
